...
for name in SROOTBASE SROOT SITE_CMAKE_DIR PATH MANPATH PKG_CONFIG_PATH LD_LIBRARY_PATH PYTHONPATH OS_ARCH GCC_VERSION OPENMP_NUM_THREADS OPENCL_VENDOR_PATH CC CXX FC
do
  eval VALUE=\$$name
  case ${SHELL##*/} in 
	tcsh)
