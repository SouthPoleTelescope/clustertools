...
for name in SROOTBASE SROOT SITE_CMAKE_DIR PATH MANPATH PKG_CONFIG_PATH LD_LIBRARY_PATH PYTHONPATH OS_ARCH GCC_VERSION OMP_NUM_THREADS OPENCL_VENDOR_PATH CC CXX FC PGPLOT_DIR PGPLOT_DEV HEALPIX HEALPIXDATA SSL_CERT_FILE PIP_DISABLE_PIP_VERSION_CHECK
do
  eval VALUE=\$$name
